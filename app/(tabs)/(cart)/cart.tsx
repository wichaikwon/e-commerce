              ...
              return (
                <View className="overflow-hidden" key={idx}>
                  ...
                  {activeItem === item.id.toString() && (
                    <View className="absolute right-0 top-0 bottom-0 w-16 bg-red-500 justify-center items-center">
                      <TouchableOpacity onPress={() => handleDelete(item.id.toString())} className="p-2 items-center">
